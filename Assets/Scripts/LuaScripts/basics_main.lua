...
---TODO 未完成为 ~window 【问题：基于C#的继承】~， Graph 【interface 泛型的导入】
---
...
function BasicMain:playGraph()
    ...
    local line = shape.graphics:GetMeshFactory1();
    ...
    GTween.To(0, 1, 5):SetEase(CS.FairyGUI.EaseType.Linear):SetTarget(shape.graphics):OnUpdate(function(t)  
        t.target:GetMeshFactory1().fillEnd = t.value.x
        t.target:SetMeshDirty()
    end);

    shape = obj:GetChild("line2").asGraph.shape;
    local line2 = shape.graphics:GetMeshFactory1();
    line2.lineWidth = 3;
    ...
    local line3 = image.displayObject.graphics:GetMeshFactory1()
    line3.lineWidth = 30;
